--- === ControlEscMap ===
---
--- Map Control to both Esc and Control -- tap for Esc, hold for Control.
---
...
-- Metadata
obj.name = 'ControlEscMap'
obj.version = '1.0'
obj.author = 'Chris Zarate <chris@zarate.org>'
obj.homepage = 'https://github.com/chriszarate/ControlEscMap.spoon'
